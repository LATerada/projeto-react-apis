          ...
          {isLoaded ?  
                <Box position='relative' w='27.5rem' h='13.125rem' radius='0.75rem' bg={cardColor(pokemon.types[0].type.name)} borderRadius='0.75rem'>
                    ...
                    <Box>
                        ...
                        <Image position='absolute' left='1.438rem' top='5.563rem' src={pokemonType(pokemon.types[0].type.name)} />
                        {pokemon.types.length > 1 ?  <Image position='absolute' left='7.06rem' top='5.563rem'  src={pokemonType(pokemon.types[1].type.name)}/> : ""}
                    </Box>
