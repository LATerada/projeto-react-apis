...
const BigPokemonCard = (props) => {
    ...
    return(
        <Grid position='relative' w='86.821rem' h='41.438rem' borderRadius='2.368rem' templateColumns='repeat(4,1fr)' templateRows='repeat(4,1fr)' bg={cardColor(pokemon.types[0].type.name)}>
            ...
            <GridItem colstart={1} colSpan={1} rowSpan={2} justifyItems='center' ><Image w='17.625rem' src={pokemon.sprites.versions["generation-v"]["black-white"].animated.front_default}/></GridItem>
            <GridItem colStart={1} rowStart={3} rowEnd={5} ><Image w='17.625rem' src={pokemon.sprites.versions["generation-v"]["black-white"].animated.back_default}/></GridItem>
            <GridItem colStart={2} colSpan={1} rowSpan={4} >Table</GridItem>
            ...
            <GridItem colStart={3} rowStart={2}>Table</GridItem>
        </Grid>
    )
