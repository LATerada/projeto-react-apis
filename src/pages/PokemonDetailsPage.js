...
const PokemonDetailsPage = () => {
    ...
    return(
        ...
        position='relative' px='1.563rem' bg='gray' pb='11.25rem' minH='90vh' wrap='wrap' justifyContent='center'>
            <Text 
            w='full'  pt={{ base: '1.5rem', md: '2rem', lg: '2.5rem', xl: '3rem', '2xl': '3.75rem' }} pb={{ base: '1.5rem', md: '2rem', lg: '2.5rem', xl: '2.9rem', '2xl': '3.438rem' }}  pl={{ base:'1.5rem',md:'2.5rem'}} textStyle='caption'>Detalhes</Text>
            <Image 
